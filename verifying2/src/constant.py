...
THRESHOLD_MAP[RGB]['abs'] = 0.81
THRESHOLD_MAP[JPEG_COMPRESSION]['abs'] = 0.91
THRESHOLD_MAP[COLOR_JITTER]['abs'] = 0.93
THRESHOLD_MAP[DEFOCUS_BLUR]['abs'] = 0.95
THRESHOLD_MAP[GAUSSIAN_NOISE]['abs'] = 0.93
THRESHOLD_MAP[CONTRAST]['abs'] = 0.98
THRESHOLD_MAP[FROST]['abs'] = 0.88
THRESHOLD_MAP[BRIGHTNESS]['abs'] = 0.93

THRESHOLD_MAP[RGB]['rel'] = 0.75
THRESHOLD_MAP[JPEG_COMPRESSION]['rel'] = 0.84
THRESHOLD_MAP[COLOR_JITTER]['rel'] = 0.99
THRESHOLD_MAP[DEFOCUS_BLUR]['rel'] = 0.95
THRESHOLD_MAP[GAUSSIAN_NOISE]['rel'] = 0.93
THRESHOLD_MAP[CONTRAST]['rel'] = 0.98
THRESHOLD_MAP[FROST]['rel'] = 0.95
THRESHOLD_MAP[BRIGHTNESS]['rel'] = 0.93
